...
function ResponsiveAppBar() {
    ...
    //+++++++++++++++++++++++++++++++++
    // le agregamos el objeto e que se
    //envia al hacer click en opcion del menu.
    const handleCloseNavMenu = (e) => {
        //console.log(e.target.innerText);
        // llamar funcion enviando e
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++
    // Guardar el Estado de la Pagina Actual
    const [myPages, setMyPages] = useState("");
    // Clonar el objeto de navegacion (history).
    const navigate = useNavigate();
    // Actualizar el estado del useState de Paginas.
